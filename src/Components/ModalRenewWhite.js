...
import white_back from '../assets/Ellipse 143.png';
const ModalRenewWhite = () => {
        ...
        <>
            ...
            <Modal.Body>
                <div className="d-flex ModalRenew_1">
                    <div>
                        <div className="d-flex justify-content-center ModalRenew_2_white">
                            Success Rate
                        </div>
                        <div className="d-flex justify-content-center ModalRenew_3_white">
                            67.6<span className="ModalRenew_4">%</span>
                        </div>
                        <div className="d-flex justify-content-center ModalRenew_2_white" style={{ marginTop: "30px" }}>
                            Win
                        </div>
                    ...
                    <div>
                        <div className="d-flex justify-content-center ModalRenew_6">
                            ...
                            <img src={white_back} alt="white_back" className="white_back" style={{ marginTop: "17px", marginLeft: "131px" }} />
                        ...
                        <div className="d-flex justify-content-center" style={{ marginTop: "115px", alignItems: "center", gridGap: "3px" }}>
                            <div className="ModalRenew_7_white">
                                ahmetvardar
                            </div>
                            <div className="ModalRenew_8_white">
                        ...
                        <div className="d-flex justify-content-center ModalRenew_9_white">
                            Ankara/Türkiye
                        </div>
                        <div className="d-flex justify-content-center ModalRenew_9_white">
                            22.04.2022
                ...
                <div className="ModalRenew_14_white">
                    Subscription Plans
                </div>
                <div className="d-flex modal_PromoteMe_4">
                    {checkedHighlight === 1 ?
                        <svg xmlns="http://www.w3.org/2000/svg" width="29.666" height="29.666" viewBox="0 0 29.666 29.666" onClick={() => { setCheckedHighlight(1) }}>
                            <g id="Ellipse_60" data-name="Ellipse 60" fill="#00659D" stroke="#00659D" stroke-width="2">
                        ...
                        :
                        <svg xmlns="http://www.w3.org/2000/svg" width="29.666" height="29.666" viewBox="0 0 29.666 29.666" onClick={() => { setCheckedHighlight(1) }}>
                            <g id="Ellipse_58" data-name="Ellipse 58" fill="none" stroke="#00659D" stroke-width="2">
                                <circle cx="14.833" cy="14.833" r="14.833" stroke="none" />
                                <circle cx="14.833" cy="14.833" r="13.833" fill="none" />
                            </g>
                        </svg>
                    }
                    <div className="modal_PromoteMe_5_white">
                        1 Month
                    </div>
                    <div className="modal_PromoteMe_6_white">
                ...
                <div className="d-flex justify-content-center modal_PromoteMe_12_white" style={{ marginTop: "50px" }}>
                    Total Amount
                </div>
                <div className="d-flex justify-content-center modal_PromoteMe_13_white">
                ...
                <div className="d-flex justify-content-center">
                    ...
                    <div className="d-flex align-items-center modal_PromoteMe_15_white">
                        I have read and agree to the <span className="modal_PromoteMe_16_white" onClick={handleShow1}> Terms of Use</span>
                        <Modal show={show1} onHide={handleClose1} dialogClassName="modal_out" id="TermsUse_white">
                            <Modal.Header closeButton>
                            </Modal.Header>
                            <Modal.Body>
                ...
                <div className="d-flex justify-content-center" style={{ marginTop: "-20px" }}>
                    <Button type="submit" className="HighLight_Checkout_button_white" outline>Checkout</Button>
                </div>
                <div className="d-flex justify-content-center modal_PromoteMe_17_white" style={{ marginTop: "5px" }}>
...
export default ModalRenewWhite;