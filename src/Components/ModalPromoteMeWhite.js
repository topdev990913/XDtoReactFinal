    ...
    return (
        <><Modal.Header closeButton>
            ...
            <Modal.Body>
                ...
                <div className="d-flex justify-content-center modal_PromoteMe_1_white">
                    Highlights
                </div>
                <div className="d-flex justify-content-center modal_PromoteMe_2_white">
                    Stand out among the best
                    increase your interactions!
                </div>
                <div className="modal_PromoteMe_3_white">
                    Highlighted Plans
                </div>
                ...
                <div className="d-flex justify-content-center modal_PromoteMe_12_white">
                    Total Amount
                </div>
                ...
                <div className="d-flex justify-content-center modal_PromoteMe_17_white">
...
export default ModalPromoteMeWhite;