...
import MainMiddleBarWhite from "./MainMiddleBarWhite";
const MainBarCommentsWhite = () => {
    ...
    return (
        <div className="MainBar_Comment_out">
            <div className="d-flex MainBar_Edit_Search_Comments_white">
                ...
                <div className="d-flex">
                    ...
                    <Button type="submit" color="info" className="MainTopHeader_button_Comment_white" onClick={handleShow} outline>Filter</Button>
                    <Modal show={show} onHide={handleClose} dialogClassName="modal_out" id="white">
                            ...
                            <Row>
                                <Col>
                                    ...
                                    <div className="crypto_dropdown">
                                        <select class="form-select form-select-lg mb-3" id="white" aria-label=".form-select-lg example">
                                        ...
                                        <div className="d-flex" onClick={() => { setPublicChecked(!publicChecked) }}>
                                            {!publicChecked ?
                                                <svg xmlns="http://www.w3.org/2000/svg" width="37" height="37" viewBox="0 0 37 37">
                                                    <circle id="Ellipse_61" data-name="Ellipse 61" cx="18.5" cy="18.5" r="18.5" fill="#0D2A53" />
                                                    <circle id="Ellipse_64" data-name="Ellipse 64" cx="18.5" cy="18.5" r="15" fill="#f6f6f6" />
                                                </svg>
                                                :
                                                <svg xmlns="http://www.w3.org/2000/svg" width="37" height="37" viewBox="0 0 37 37">
                                            ...
                                            <div className="Filter_Modal_Label_white" style={{ marginLeft: "5px" }}>
                                                Only Public
                                            </div>
                                        </div>
                                    </Col>
                        ...
                        <Modal.Footer style={{ display: "flex", justifyContent: "center", marginTop: "-10px" }}>
                            <Button type="submit" color="info" className="modal_Footer_Button_white" outline>Show</Button>
                        </Modal.Footer>
                    </Modal>
...
export default MainBarCommentsWhite;
