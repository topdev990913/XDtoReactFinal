...
const VPFavouriteCard = ({ checkedFavourite, setCheckedFavourite, checkedViewProfileGo, setCheckedViewProfileGo }) => {
    console.log("_view", checkedViewProfileGo)
    return (
        <div className="VPFavouriteCard_out">
            ...
            <Link to="/FavoriteViewProfile"><Button type="submit" className="Favourite_ViewProfile_butoon" outline style={{marginLeft: "65.7px"}} onClick={()=>{setCheckedViewProfileGo(true)}}>View Profile</Button></Link>
