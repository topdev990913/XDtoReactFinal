...
const MyCommentsEditProfileViewProfile = ({ checkedBall, setCheckedBall }, { checkedViewProfile, setCheckedViewProfile }) => {
    return (
...
export default MyCommentsEditProfileViewProfile;