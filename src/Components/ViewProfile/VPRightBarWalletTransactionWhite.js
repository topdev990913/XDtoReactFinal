    ...
    return (
        <div className="VPRightBarWallet_out_white">
            <div className="d-flex">
                <div className="VPRightBarWallet_1_white">
                    <div className="VPRightBarWallet_3_white">
                        Total Balance
                    </div>
                    <div className="d-flex justify-content-center VPRightBarWallet_4_white">
                        12.650<span className="VPRightBarWallet_5">₺</span>
                    </div>
                    <div className="d-flex VPRightBarWallet_6">
                        <div className="VPRightBarWallet_7">
                            <div className="VPRightBarWallet_8_white">
                                Available Balance
                            </div>
                            <div className="VPRightBarWallet_8_white">
                                Progress
                ...
                <div className="VPRightBarWallet_2_white">
                    <div className="d-flex VPRightBarWallet_15_white">
                        <div>May</div>
                        <div>Jun</div>
                        <div>Jul</div>
                        <div>Aug</div>
            ...
            <div className="VPRightBarWallet_16_white">
                <div className="VPRightBarWallet_17">
                    AKBANK
                </div>
                <div className="VPRightBarWallet_18_white">
            ...
            <div className="VPRightBarWallet_19_white">
                History
            </div>
            <div className="VPRightBarWallet_20_white" style={{ marginTop: "27.1px" }}>
                <div className="VPRightBarWallet_21_white">
                    New Subscriber
                </div>
                <div className="VPRightBarWallet_21_white" style={{ marginLeft: "42px" }}>
                    1 Month
                </div>
                <div className="VPRightBarWallet_21_white" style={{ marginLeft: "39.6px" }}>
                    22.04.2023
                </div>
                <div className="VPRightBarWallet_22_white" style={{ marginLeft: "32.8px" }}>
                    100.00
                </div>
                <div className="VPRightBarWallet_23_white" style={{ marginLeft: "26.5px" }}>
                    %25
                </div>
                <div className="VPRightBarWallet_24" style={{ marginLeft: "23.5px" }}>
                    75.00+
                </div>
                <div className="VPRightBarWallet_25_white" style={{ marginLeft: "23.9px" }}>
                ...
                <div className="VPRightBarWallet_27">
                    <svg xmlns="http://www.w3.org/2000/svg" width="86.292" height="57.879" viewBox="0 0 86.292 57.879">
                        <g id="Path_199" data-name="Path 199" transform="translate(-11)" fill="#FFFFFF">
            ...
            <div className="VPRightBarWallet_20_white">
                ...
                <div className="VPRightBarWallet_21_white" style={{ marginLeft: "139.7px" }}>
                    22.04.2023
                </div>
                <div className="VPRightBarWallet_28" style={{ marginLeft: "191.5px" }}>
                    75.00-
...
export default VPRightBarWalletTransactionWhite;