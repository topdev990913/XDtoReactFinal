        ...
        <div className="VPRightBarWallet_out">
            ...
            <div className="row" style={{ marginTop: "15px" }}>
                <div className="VPRightBarWalletTransactionPending_5">
                    <div className="VPRightBarWalletTransactionPending_3">
                        ID
                    </div>
                    <div className="VPRightBarWalletTransactionPending_4">
                        # 0001
                    </div>
                    <div className="VPRightBarWalletTransactionPending_4">
                        # 0001
            ...
            <div className="VPRightBarWalletTransactionPending_11">
                Revenue from subscription sales is reflected as self-deductible amounts after 15 days.<br />
                <span className="VPRightBarWalletTransactionPending_12">For sales realized with 3 - 6 - 12 month options,<br />
...
export default VPRightBarWalletTransactionPending;