...
const MainMiddleBarFooterWhite = () => {
    return (
        <div className="MainMiddleBarFooter_out d-flex">
            <div className="d-flex justify-content-start align-items-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="45.558" height="45.558" viewBox="0 0 45.558 45.558">
                    <g id="heart" transform="translate(0)">
                        ...
                        <path id="Path_308" data-name="Path 308" d="M33.795,19.863,19.8,33.6,5.81,19.863a9.191,9.191,0,0,1-2.4-9.373A9.361,9.361,0,0,1,19.8,7.72a9.361,9.361,0,0,1,16.36,2.8,9.191,9.191,0,0,1-2.368,9.353" transform="translate(2.993 3.986)" fill="none" stroke="#0d2a53" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" />
                    </g>
                </svg>
                <div className="Footer_text_white">238</div>
                <svg id="star" xmlns="http://www.w3.org/2000/svg" width="39.863" height="39.864" viewBox="0 0 39.863 39.864" style={{ marginLeft: "21.68px" }}>
                    ...
                    <path id="Path_273" data-name="Path 273" d="M18.189,27.3,8.194,32.515,10.1,21.473l-8.1-7.819L13.18,12.048,18.178,2l5,10.046,11.173,1.607-8.1,7.819,1.909,11.042Z" transform="translate(1.741 1.737)" fill="none" stroke="#0D2A53" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" />
                </svg>
                <div className="Footer_text_white">238</div>
...
export default MainMiddleBarFooterWhite;
